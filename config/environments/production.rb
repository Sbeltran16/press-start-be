...
Rails.application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = ENV['PRESS_START_HOST'] || 'https://press-start-be.onrender.com'
  ...
  # config.active_job.queue_name_prefix = "press_start_be_production"
